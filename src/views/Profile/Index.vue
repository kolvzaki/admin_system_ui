        ...
        <div class="card-content" style="flex-flow: column;">
          ...
          <div class="info-part">
            ...
            <div class="security-button-contain">
              <el-button type="warning" size="small" class="hvr-push" @click="showEditPassDialog">
                {{ i18nProfile("security.changePasswordButton") }}
              </el-button>
...
const {dateFormat,genderOptions} = globalHooks()


const rpVal = ref("role");

const initPassForm = () => {
  passForm.newPass = passForm.confirmPass = passForm.oldPass = "";
};
